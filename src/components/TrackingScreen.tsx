  ...
  const sendUserMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (currentStep === 1) {
        ...
        reply = 'Perfecto, voy cruzando el Bloque B. Llego en un par de minutos.';
        ...
        <div className="relative flex flex-col gap-5 mt-2">
          ...
          <div className={`flex items-start gap-4 z-10 p-3 rounded-2xl border transition-all ${
            ...
            <div className="leading-tight">
              ...
              <p className="text-[10.5px] font-semibold text-slate-500 mt-1">
                Rider aproximándose al Campus Norte UPN, Bloque B. ¡Prepárate para recibir tu plato!
              </p>
            </div>
          </div>
        ...
        <div className="p-4 rounded-2xl border border-slate-105 bg-white flex items-center gap-3.5 shadow-2xs">
          ...
          <div className="flex-grow min-w-0 text-left">
            ...
            <div className="flex items-center gap-1 mt-0.5 text-[10.5px] text-slate-500">
              <span className="material-icons-span text-[#fc9d41] text-xs font-black">star</span>
              <span className="font-extrabold text-[#fc9d41]">4.9</span>
              <span>•</span>
              <span className="font-semibold">Servicio de Confianza UPN</span>
            </div>
          </div>
